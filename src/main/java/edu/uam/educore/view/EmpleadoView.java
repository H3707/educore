...
public class EmpleadoView extends VistaBase {
    ...
    private void registrar() {
        ...
        try {
            Empleado registrado = controller.registrar(nombre, apellidos, email, salario, fechaIngreso, tipo);
            if (registrado != null) {
    ...
    private void actualizar() {
        ...
        try {
            ...
            Empleado actualizado = controller.actualizar(id, nombre, apellidos, email, salario, fechaIngreso, tipo);
