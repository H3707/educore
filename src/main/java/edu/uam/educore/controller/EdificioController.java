...
public class EdificioController {
  ...
  public void eliminarEdificio(int id) throws Exception {
    ...
    if (!e.getAulas().isEmpty()) {
      throw new IllegalArgumentException(
          "No se puede eliminar el edificio debido a que contiene aulas.");
    }
    repo.eliminar(id);
  }
  ...
  public Aula agregarAula(int edificioId, String numero, int capacidad, TipoAula tipo)
    ...
    if (e == null) {
      throw new IllegalArgumentException(
          "No existe un edificio con el identificador: " + edificioId);
    }
  ...
  public void eliminarAula(int edificioId, int aulaId) throws Exception {
    ...
    if (!eliminada) {
      throw new IllegalArgumentException(
          "No existe el aula con el identificador " + aulaId + " en este edificio.");
    }
    repo.actualizar(e);
  }
}
